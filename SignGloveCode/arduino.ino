...
if(millis() - timer > 1000){
  Serial.println("=======================================================");
   Serial.println("Pink Angle (1): " + String(angle1));
  Serial.println("Index Angle (2): " + String(angle2));
  Serial.println("Middle Angle (3): " + String(angle3));
  Serial.println("Ring Angle (4): " + String(angle4));
  Serial.println("Thumb Angle (5): " + String(angle5));
  ...
  //x
  if(((angle1>=50)&&(angle1<=72))&&((angle2>=45)&&(angle2<=90))&&((angle3>=35)&&(angle3<=75))&&((angle4>=80)&&(angle4<=89))&&((angle5>=45)&&(angle5<=80)))
  playSound(0x0306);
